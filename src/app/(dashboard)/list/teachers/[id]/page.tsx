          ...
          <div className="bg-Sky py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              ...
              <p className="text-sm text-gray-500">
                John is a dedicated and experienced teacher with over 10 years
                of experience in the education field. He specializes in
                mathematics and has a passion for helping students achieve their
                full potential.
              </p>
